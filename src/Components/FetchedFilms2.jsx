...
const FetchedFilms2 = props => {
  ...
  return (
    <Container className="container-92">
      <h1 className="text-white fs-4 my-3">Watch It Again</h1>
      <Row className="g-1">
...
export default FetchedFilms2;

// import { Component } from "react";
// import { Alert, Col, Container, Row } from "react-bootstrap";

// class FetchedFilms2 extends Component {
//   state = {
//     films: [],
//     hasError: false,
//     errorMessage: "",
...
//   fetchFilm = async () => {
//     try {
//       const response = await fetch(`http://www.omdbapi.com/?apikey=ce6cbdb9&s=${this.props.film}`);
//       if (response.ok) {
//         const films = await response.json();
...
//         <h1 className="text-white fs-4 my-3">Watch It Again</h1>
//         <Row className="g-1">
//           {!this.state.hasError && this.state.films.length > 0 ? (
//             this.state.films.slice(0, 6).map(film => (
//               <Col key={film.imdbID} xs={12} sm={6} md={4} xl={2} className="col-12 mb-1 px-half">
//                 <img style={{ height: "330px" }} className="img-fluid" src={film.Poster} alt={film.Title} />
//               </Col>
//             ))
//           ) : (
