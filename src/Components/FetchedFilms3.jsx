...
const FetchedFilms3 = props => {
  ...
  return (
    <Container className="container-92">
      <h1 className="text-white fs-4 my-3">New Releases</h1>
      <Row className="g-1">
...
export default FetchedFilms3;

// import { Component } from "react";
// import { Alert, Col, Container, Row } from "react-bootstrap";

// class FetchedFilms3 extends Component {
//   state = {
//     films: [],
//     hasError: false,
//     errorMessage: "",
...
//               <Col key={film.imdbID} xs={12} sm={6} md={4} xl={2} className="mb-1 px-half">
//                 <img style={{ height: "330px" }} className="img-fluid" src={film.Poster} alt={film.Title} />
//               </Col>
//             ))
//           ) : (
